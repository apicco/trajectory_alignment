...
_intensity_normalisation_ can be: _None_ (no normalisation, default), _Integral_ (normalise over the integral of the fluorescence intensity to be 1. It uses .scale_f( v = 1 ) ), or _Absolute_ (normalise the fluorescence intensity values between 0 and 1 using norm_f() )
